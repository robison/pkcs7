...
// NewSignedImage takes a UEFI ASN1 struct (constructed externally) and initializes a
// PKCS7 SignedData struct that is ready to be signed via AddSigner. The digest algorithm
// is set to SHA2-256 by default and can be changed by calling SetDigestAlgorithm.
